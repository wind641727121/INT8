...
void Backward(XTensor &input, XTensor &gold, FNNRegModel &model, FNNRegModel &grad, FNNRegNet &net)
{
	...
	net.hidden_state2.Dump(&net.hidden_state2, stderr, "hidden_state2: ");
	net.hidden_state3.Dump(&net.hidden_state3, stderr, "hidden_state3: ");
	grad.b.Dump(&grad.b, stderr, "grad.b: ");
	input.Dump(&input, stderr, "input: ");
    dedw1 = MatrixMul(input, X_NOTRANS, dedb, X_NOTRANS);
